...
class ProjectServiceTest {
	...
	private static Stream<Arguments> projectKeywordSearchSource() {
		return Stream.of(
			...
			Arguments.arguments("PROJECT_NAME", "프로젝트", "NOT_STARTED", 1, 4),
			Arguments.arguments(null, null, "NOT_STARTED", 1, 4),
			Arguments.arguments(null, null, "IN_PROGRESS", 1, 4),
			Arguments.arguments(null, null, "PAUSED", 1, 4),
			Arguments.arguments(null, null, "PAUSED", 2, 0)
		);
	}
	...
	private static Stream<Arguments> projectKeywordTotalCountSource() {
		return Stream.of(
			...
			Arguments.arguments("PROJECT_NAME", "프로젝트", "NOT_STARTED", 4),
			Arguments.arguments(null, null, "NOT_STARTED", 4),
			Arguments.arguments(null, null, "IN_PROGRESS", 4),
			Arguments.arguments(null, null, "PAUSED", 4)
		);
	}
}
